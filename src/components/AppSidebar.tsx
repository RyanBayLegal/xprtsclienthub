import { LayoutDashboard, Users, UserCircle, BarChart3, LogOut, Calendar, ListTodo, Settings, UsersRound, Store, Link2, Clock, Timer } from "lucide-react";
...
const allItems = [
  ...
  { title: "Activities", url: "/activities", icon: Timer, roles: ["team_admin"] },
